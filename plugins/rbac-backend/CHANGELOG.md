...
* **@janus-idp/backstage-plugin-audit-log-node:** upgraded to 1.5.2
* **@janus-idp/backstage-plugin-rbac-common:** upgraded to 1.10.1
* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.6.1
...
## @janus-idp/backstage-plugin-rbac-backend [4.5.0](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-rbac-backend@4.4.3...@janus-idp/backstage-plugin-rbac-backend@4.5.0) (2024-07-26)
...
* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.4.0
...
* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.1.1
...
## @janus-idp/backstage-plugin-rbac-backend [2.6.3](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-rbac-backend@2.6.2...@janus-idp/backstage-plugin-rbac-backend@2.6.3) (2024-04-15)



### Dependencies

* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.1.0

## @janus-idp/backstage-plugin-rbac-backend [2.6.2](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-rbac-backend@2.6.1...@janus-idp/backstage-plugin-rbac-backend@2.6.2) (2024-04-09)



### Dependencies

* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.0.6

## @janus-idp/backstage-plugin-rbac-backend [2.6.1](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-rbac-backend@2.6.0...@janus-idp/backstage-plugin-rbac-backend@2.6.1) (2024-04-08)



### Dependencies

* **@janus-idp/backstage-plugin-rbac-node:** upgraded to 1.0.5

## @janus-idp/backstage-plugin-rbac-backend [2.6.0](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-rbac-backend@2.5.1...@janus-idp/backstage-plugin-rbac-backend@2.6.0) (2024-04-05)
