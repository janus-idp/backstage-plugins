...
import { CustomSingleInstanceGithubCredentialsProvider } from './GithubAppManager';
...
describe('CustomSingleInstanceGithubCredentialsProvider tests', () => {
  ...
  // TODO: add tests for the extended functionality added in the CustomSingleInstanceGithubCredentialsProvider
});
