...
import type {GithubCredentials, GithubIntegrationConfig, ScmIntegrations} from "@backstage/integration";
import {computeTotalCountFromGitHubToken, createCredentialError, handleError} from "./utils";
import {Octokit} from "@octokit/rest";
import {DefaultPageNumber, DefaultPageSize} from "../../service/handlers/handlers";
import type {GithubAppCredentials, GithubFetchError, GithubRepository} from "../types";
...
export async function addGithubTokenRepositories(
    ...
    try {
        if (search) {
            ...
            totalCount = await computeTotalCountFromGitHubToken(deps,
