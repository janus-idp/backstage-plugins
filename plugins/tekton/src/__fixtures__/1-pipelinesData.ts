  ...
  pods: [
    {
      metadata: {
        ...
        creationTimestamp: '2023-03-30T07:04:54Z',
        labels: {
          app: 'ruby-ex-git',
  ...
  pipelineruns: [
    {
      ...
      metadata: {
        ...
        creationTimestamp: '2023-03-30T07:03:04Z',
        generation: 1,
        labels: {
  ...
  taskruns: [
    {
      ...
      metadata: {
        ...
        creationTimestamp: '2023-03-30T07:03:20Z',
        generation: 1,
        labels: {
          'app.kubernetes.io/instance': 'ruby-ex-git',
        ...
        managedFields: [
          {
            ...
            fieldsV1: {
              'f:metadata': {
                ...
                'f:ownerReferences': {
                  '.': {},
                  'k:{"uid":"b7584993-146c-4d4d-ba39-8619237e940b"}': {},
                },
              },
              'f:spec': {
                '.': {},
