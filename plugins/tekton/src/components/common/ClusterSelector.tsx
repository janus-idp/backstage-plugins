...
export const ClusterSelector = () => {
  ...
  const curCluster =
    selectedCluster && k8sClusters?.length > 0 ? k8sClusters[selectedCluster] : k8sClusters?.[0];

  const [clusterSelected, setClusterSelected] = React.useState<SelectedItems>(curCluster);
