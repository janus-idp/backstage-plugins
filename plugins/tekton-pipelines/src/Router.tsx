...
export const Router = (props: { refreshIntervalMs?: number }) => {
  ...
  const tektonPipelinesLabelSelectorQueryAnnotationValue =
    ...
    if (tektonPipelinesAnnotationValue || tektonPipelinesLabelSelectorQueryAnnotationValue) {
      return (
        <Routes>
          <Route
            path="/"
    ...
    return (
      <>
        <MissingAnnotationEmptyState annotation={TEKTON_PIPELINES_BUILD_NAMESPACE} />
        <h1>
