...
// markup not found, no include::{specDir}v2/workflows/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}v2/workflows/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}v2/workflows/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :v2/workflows/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}v2/workflows/POST/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}v2/specs/GET/spec.adoc[opts=optional]
...
| 200
| Successful retrieval of workflow specifications
| List[<<WorkflowSpecFileDTO>>] 


| 500
| Error fetching workflow specifications
|  <<String>>
...
// markup not found, no include::{snippetDir}v2/specs/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}v2/specs/GET/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :v2/specs/GET/GET.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}v2/specs/GET/implementation.adoc[opts=optional]
...
=== _CreateWorkflow201Response_ 



[.fields-CreateWorkflow201Response]
[cols="2,1,2,4,1"]
|===
| Field Name| Required| Type| Description| Format
...
[#CreateWorkflowRequest]
=== _CreateWorkflowRequest_ 



[.fields-CreateWorkflowRequest]
[cols="2,1,2,4,1"]
|===
| Field Name| Required| Type| Description| Format
...
[#WorkflowSpecFileDTO]
=== _WorkflowSpecFileDTO_ 



[.fields-WorkflowSpecFileDTO]
[cols="2,1,2,4,1"]
|===
| Field Name| Required| Type| Description| Format
