...
export const fakeSpecs: WorkflowSpecFile[] = [
  {
    path: '/var/tmp/orchestrator/workflows/specs/actions-openapi.json',
    content: {
      openapi: '3.0.1',
      info: {
  ...
  {
    path: '/var/tmp/orchestrator/workflows/specs/jira-openapi.json',
    content: {
      openapi: '3.0.1',
      info: {
