import { ImportJobStatus } from '../types/response-types';
import { AddedRepositories, ApprovalTool } from '../types/types';
...
export const mockGetImportJobs: ImportJobStatus[] = [
  {
  ...
  },
  {
    ...
    github: {
      pullRequest: {
        number: 92,
        url: 'https://github.com/org/dessert/kitkat/pull/92',
      },
    },
    lastUpdate: '2024-07-19T13:46:37Z',
    repository: {
      id: 'org/dessert/kitkat',
      name: 'kitkat',
      url: 'https://github.com/org/dessert/kitkat',
  ...
  },
  {
    ...
    github: {
      pullRequest: {
        number: 93,
        url: 'https://github.com/org/dessert/oreo/pull/93',
      },
    },
    lastUpdate: '2024-07-20T13:46:37Z',
    repository: {
      id: 'org/dessert/oreo',
      name: 'oreo',
      url: 'https://github.com/org/dessert/oreo',
