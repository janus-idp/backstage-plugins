...
export const setPFColorVals = (element: Element) => {
  PFColorVals = {
    ...
    Black100: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black100),
    ),
    Black150: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black150),
    ),
    Black200: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black200),
    ),
    Black300: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black300),
    ),
    Black400: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black400),
    ),
    Black500: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black500),
    ),
    Black600: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black600),
    ),
    Black700: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black700),
    ),
    Black1000: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Black1000),
    ),
    Blue50: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Blue50),
    ),
    Blue300: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Blue300),
    ),
    Blue600: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Blue600),
    ),
    Red50: getComputedStyle(element).getPropertyValue(getColor(PFColors.Red50)),
    Orange50: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Orange50),
    ),
    Gold400: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Gold400),
    ),
    Green400: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Green400),
    ),
    Purple200: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Purple200),
    ),
    White: getComputedStyle(element).getPropertyValue(getColor(PFColors.White)),

    // status color values used by kiali
    Danger: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Danger),
    ),
    Success: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Success),
    ),
    Warning: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Warning),
    ),

    // PF colors (compatible with dark mode)
    BackgroundColor100: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.BackgroundColor100),
    ),
    BackgroundColor200: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.BackgroundColor200),
    ),

    Color100: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Color100),
    ),
    Color200: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.Color200),
    ),

    BorderColor100: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.BorderColor100),
    ),
    BorderColor200: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.BorderColor200),
    ),
    BorderColor300: getComputedStyle(element).getPropertyValue(
      getColor(PFColors.BorderColor300),
    ),
  };
};
