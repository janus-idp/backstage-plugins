...
export const AccessLogModal: React.FC<AccessLogModalProps> = (
  props: AccessLogModalProps,
) => {
          ...
          <>
            ...
            <dd>
              <dl className="simple">
                ...
                <dd>
                  <p>
                    Body bytes sent. For WebSocket connection it will also
                    include response header bytes.
                  </p>
                </dd>
                <dt>TCP</dt>
                <dd>
      ...
      case 'downstream local':
        return (
          <>
            ...
            <dd>
              <p>
                Local address of the downstream connection. If the address is an
                IP address it includes both address and port. If the original
                connection was redirected by iptables REDIRECT, this represents
                ...
                using SO_ORIGINAL_DST socket option. If the original connection
                was redirected by iptables TPROXY, and the listener’s
      ...
      case 'downstream remote':
        return (
          <>
            ...
            <dd>
              <p>
                Remote address of the downstream connection. If the address is
                an IP address it includes both address and port.
              </p>
          ...
          <>
            ...
            <dd>
              <dl className="simple">
                ...
                <dd>
                  <p>
                    Protocol. Currently either <em>HTTP/1.1</em> or{' '}
                    <em>HTTP/2</em>.
                  </p>
                </dd>
                <dt>TCP</dt>
          ...
          <>
            ...
            <dd>
              <dl className="simple">
                ...
                <dd>
                  <p>
                    RequestId is the envoy generated X-REQUEST-ID header
                    "%REQ(X-REQUEST-ID)%"
                  </p>
                </dd>
                <dt>TCP</dt>
      ...
      case 'response flags':
        return (
          <>
            ...
            <dd>
              <p>
                Additional details about the response or connection, if any. For
                TCP connections, the response codes mentioned in the
                descriptions do not apply. Possible values are:
              </p>
              <dl className="simple">
                <dt>HTTP and TCP</dt>
                <dd>
                  <ul className="simple">
                    <li>
                      <p>
                        <strong>UH</strong>: No healthy upstream hosts in
                        upstream cluster in addition to 503 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>UF</strong>: Upstream connection failure in
                    ...
                    <li>
                      <p>
                        ...
                        for a given request in addition to 404 response code, or
                        no matching filter chain for a downstream connection.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>URX</strong>: The request was rejected because
                        the{' '}
                        <a
                          className="reference internal"
                ...
                <dd>
                  <ul className="simple">
                    ...
                    <li>
                      <p>
                        <strong>UT</strong>: Upstream request timeout in
                        addition to 504 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>LR</strong>: Connection local reset in addition
                        to 503 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>UR</strong>: Upstream remote reset in addition
                        to 503 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>UC</strong>: Upstream connection termination in
                        addition to 503 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>DI</strong>: The request processing was delayed
                        for a period specified via{' '}
                        <a
                          className="reference internal"
                    ...
                    <li>
                      <p>
                        <strong>FI</strong>: The request was aborted with a
                        response code specified via{' '}
                        <a
                          className="reference internal"
                          href="/docs/envoy/latest/configuration/http/http_filters/fault_filter#config-http-filters-fault-injection"
                        >
                    ...
                    <li>
                      <p>
                        <strong>RL</strong>: The request was ratelimited locally
                        by the{' '}
                        <a
                          className="reference internal"
                    ...
                    <li>
                      <p>
                        <strong>UAEX</strong>: The request was denied by the
                        external authorization service.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>RLSE</strong>: The request was rejected because
                        there was an error in rate limit service.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>IH</strong>: The request was rejected because it
                        set an invalid value for a{' '}
                        <a
                          className="reference internal"
                    ...
                    <li>
                      <p>
                        <strong>SI</strong>: Stream idle timeout in addition to
                        408 response code.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>DPE</strong>: The downstream request had an HTTP
                        protocol error.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>UPE</strong>: The upstream response had an HTTP
                        protocol error.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>UMSDR</strong>: The upstream request reached to
                        max stream duration.
                      </p>
                    </li>
                  </ul>
      ...
      case 'route name':
        return (
          <>
            ...
            <dd>
              <p>
                RouteName is the name of the VirtualService route which matched
                this request %ROUTE_NAME%
              </p>
            </dd>
          </>
        );
            ...
            <dd>
              <dl>
                ...
                <dd>
                  ...
                  <p>
                    Note that in the case of 100-continue responses, only the
                    response code of the final headers will be logged. If a
                    100-continue is followed by a 200, the logged response will
                    be 200. If a 100-continue results in a disconnect, the 100
                    will be logged.
                  </p>
                </dd>
                <dt>TCP</dt>
          ...
          <>
            ...
            <dd>
              <dl className="simple">
                ...
                <dd>
                  <p>
                    TCPServiceTime is the X-ENVOY-UPSTREAM-SERVICE-TIME header
                    "%REQ(X-ENVOY-UPSTREAM-SERVICE-TIME)%"
                  </p>
                </dd>
                <dt>TCP</dt>
                <dd>
          ...
          <>
            ...
            <dd>
              ...
              <p>
                ...
                . In addition to that, START_TIME also accepts following
                specifiers:
              </p>
              <Table className={tableStyle}>
                <TableHead>
                  <TableRow className="row-odd">
                    <TableCell width={30} className="head">
                      <p>Specifier</p>
                    </TableCell>
                    <TableCell width={70} className="head">
                      <p>Explanation</p>
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  <TableRow className="row-even">
                    <TableCell>
                      <p>
                        <code className="docutils literal notranslate">
                  ...
                  <TableRow className="row-odd">
                    ...
                    <TableCell>
                      <p>
                        Fractional seconds digits, default is 9 digits
                        (nanosecond)
                      </p>
                    </TableCell>
                  </TableRow>
      ...
      case 'upstream cluster':
        return (
          <>
            ...
            <dd>
              <p>
                Upstream cluster to which the upstream host belongs to. If
                runtime feature
                <cite>
              ...
              <dl className="simple">
                ...
                <dd>
                  <p>
                    ...
                    TLS handshake), provides the failure reason from the
                    transport socket. The format of this field depends on the
                    configured upstream transport socket. Common TLS failures
                    are in{' '}
                    <a
                      className="reference internal"
      ...
      case 'upstream local':
        return (
          <>
            ...
            <dd>
              <p>
                Local address of the upstream connection. If the address is an
                IP address it includes both address and port.
              </p>
            </dd>
          </>
        );
      ...
      <div style={{ height: '85%' }}>
        ...
        <Split style={{ height: '100%' }}>
          <SplitItem className={classes(splitStyle, contentStyle)}>
            {accessLogContent(props.accessLog)}
          </SplitItem>
          <SplitItem className={classes(splitStyle, descriptionStyle)}>
            {description}
          </SplitItem>
        </Split>
      </div>
