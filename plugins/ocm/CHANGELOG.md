...
- fef0f60: replaced pf-icons with mui icons
...
- Updated dependencies [45903e9]
  - @janus-idp/backstage-plugin-ocm-common@3.5.0

* **@janus-idp/cli:** upgraded to 1.15.2

### Dependencies

- **@janus-idp/backstage-plugin-ocm-common:** upgraded to 3.4.1
...
## @janus-idp/backstage-plugin-ocm [3.8.1](https://github.com/janus-idp/backstage-plugins/compare/@janus-idp/backstage-plugin-ocm@3.8.0...@janus-idp/backstage-plugin-ocm@3.8.1) (2024-04-25)
