(() => {
  var e = {
      93: (e, t, n) => {
        ...
        function O() {
          for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
            t[n] = arguments[n];
          R.apply(void 0, [O, t.length].concat(t));
        }
        (N.fail = function e(t, n, o, s, a) {
          var l,
            u = arguments.length;
          if (0 === u) l = 'Failed';
          ...
          (N.notDeepEqual = function e(t, n, r) {
            if (arguments.length < 2) throw new m('actual', 'expected');
            void 0 === l && C(),
              l(t, n) &&
                x({
          ...
          (N.deepStrictEqual = function e(t, n, r) {
            if (arguments.length < 2) throw new m('actual', 'expected');
            void 0 === l && C(),
              u(t, n) ||
                x({
          ...
          (N.notDeepStrictEqual = function e(t, n, r) {
            if (arguments.length < 2) throw new m('actual', 'expected');
            void 0 === l && C();
            u(t, n) &&
              x({
          ...
          (N.strictEqual = function e(t, n, r) {
            if (arguments.length < 2) throw new m('actual', 'expected');
            S(t, n) ||
              x({
                actual: t,
          ...
          (N.notStrictEqual = function e(t, n, r) {
            if (arguments.length < 2) throw new m('actual', 'expected');
            S(t, n) &&
              x({
                actual: t,
          ...
          if ('function' != typeof t) {
            ...
            return (
              ...
              s.forEach(function (i) {
                ('string' == typeof e[i] && _(t[i]) && E(t[i], e[i])) ||
        ...
        function F(e, t, n, r) {
          ...
          if (n && !M(t, n, r, e)) throw t;
        }
        function D(e, t, n, r) {
          if (t !== A) {
            if (
              ('string' == typeof n && ((r = n), (n = void 0)), !n || M(t, n))
            ) {
              var i = r ? ': '.concat(r) : '.',
        ...
        function j(e, t, n, r, i) {
          if (!_(t)) throw new f('regexp', 'RegExp', t);
          var s = 'match' === i;
          if ('string' != typeof e || E(t, e) !== s) {
        ...
        function q() {
          for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
            t[n] = arguments[n];
          R.apply(void 0, [q, t.length].concat(t));
        }
        (N.throws = function e(t) {
          ...
          (N.match = function e(t, n, r) {
            j(t, n, r, e, 'match');
          }),
          (N.doesNotMatch = function e(t, n, r) {
            j(t, n, r, e, 'doesNotMatch');
          }),
          (N.strict = w(q, N, {
            equal: N.strictEqual,
      ...
      801: (e, t, n) => {
        ...
        var b = n(208).inspect,
          y = n(342).codes.ERR_INVALID_ARG_TYPE;
        function v(e, t, n) {
          return (
        ...
        function A(e, t, n) {
          ...
          for (
            var m = c[c.length - 1], b = h[h.length - 1];
            m === b &&
            ...
            (m = c[c.length - 1]), (b = h[h.length - 1]);
          var y = Math.max(c.length, h.length);
          if (0 === y) {
            var L = u.split('\n');
            if (L.length > 30)
              for (L[26] = ''.concat(_, '...').concat(E); L.length > 27; )
                L.pop();
            return ''.concat(C.notIdentical, '\n\n').concat(L.join('\n'), '\n');
          }
          f > 3 && ((a = '\n'.concat(_, '...').concat(E).concat(a)), (l = !0)),
            '' !== i && ((a = '\n  '.concat(i).concat(a)), (i = ''));
          var A = 0,
            x =
              C[n] +
              '\n'
                ...
                .concat(S, '- expected')
                .concat(E),
            R = ' '.concat(_, '...').concat(E, ' Lines skipped');
          for (f = 0; f < y; f++) {
            var O = f - s;
            if (c.length < f + 1)
              O > 1 &&
                f > 2 &&
                (O > 4
                  ? ((o += '\n'.concat(_, '...').concat(E)), (l = !0))
                  : O > 3 && ((o += '\n  '.concat(h[f - 2])), A++),
                (o += '\n  '.concat(h[f - 1])),
                A++),
                (s = f),
                (i += '\n'.concat(S, '-').concat(E, ' ').concat(h[f])),
                A++;
              ...
              O > 1 &&
                ...
                A++),
                (s = f),
                (o += '\n'.concat(w, '+').concat(E, ' ').concat(c[f])),
                A++;
            else {
              var k = h[f],
                M = c[f],
                P = M !== k && (!v(M, ',') || M.slice(0, -1) !== k);
              P && v(k, ',') && k.slice(0, -1) === M && ((P = !1), (M += ',')),
                P
                  ? (O > 1 &&
                      f > 2 &&
                      (O > 4
                      ...
                      A++),
                    (s = f),
                    (o += '\n'.concat(w, '+').concat(E, ' ').concat(M)),
                    (i += '\n'.concat(S, '-').concat(E, ' ').concat(k)),
                    (A += 2))
                  : ((o += i),
                    (i = ''),
                    (1 !== O && 0 !== f) || ((o += '\n  '.concat(M)), A++));
            ...
            if (((Error.stackTraceLimit = 0), null != n))
              ...
              if (
                ('notStrictEqual' === i &&
                  'object' === p(s) &&
                  null !== s &&
                  (h = C.notStrictEqualObject),
                d.length > 30)
              )
                for (d[26] = ''.concat(_, '...').concat(E); d.length > 27; )
                  d.pop();
              t =
                1 === d.length
      ...
      656: (e, t, n) => {
        ...
        var d = f(Object.prototype.hasOwnProperty),
          ...
          p = n(208).types,
          b = p.isAnyArrayBuffer,
          y = p.isArrayBufferView,
          v = p.isDate,
          _ = p.isMap,
          w = p.isRegExp,
          S = p.isSet,
          E = p.isNativeError,
          C = p.isBoxedPrimitive,
          L = p.isNumberObject,
          N = p.isStringObject,
          A = p.isBooleanObject,
          x = p.isBigIntObject,
        ...
        function q(e, t, n, r) {
          ...
          if (Array.isArray(e)) {
            ...
            var d = P(e),
              g = P(t);
            return d.length === g.length && V(e, t, n, r, F, d);
          }
          if ('[object Object]' === f && ((!_(e) && _(t)) || (!S(e) && S(t))))
            return !1;
          if (v(e)) {
            if (
              !v(t) ||
            ...
            if (y(e)) {
              ...
              var p = P(e),
                M = P(t);
              return p.length === M.length && V(e, t, n, r, I, p);
            }
            if (S(e)) return !(!S(t) || e.size !== t.size) && V(e, t, n, r, D);
            if (_(e)) return !(!_(t) || e.size !== t.size) && V(e, t, n, r, j);
            if (b(e)) {
              if (
                ((a = t),
                (i = e).byteLength !== a.byteLength ||
                  0 !== T(new Uint8Array(i), new Uint8Array(a)))
              )
                return !1;
            } else if (
              C(e) &&
            ...
            if (0 !== m.length) {
              ...
              for (f = 0; f < m.length; f++) {
                ...
                if (g(e, b)) {
                  if (!g(t, b)) return !1;
                  u.push(b), p++;
                } else if (g(t, b)) return !1;
              }
              var y = c(t);
              if (m.length !== y.length && B(t, y).length !== p) return !1;
            } else {
              var v = c(t);
              if (0 !== v.length && 0 !== B(t, v).length) return !1;
            }
          }
          if (
            0 === u.length &&
            (s === I || (s === F && 0 === e.length) || 0 === e.size)
          )
            return !0;
          if (void 0 === i)
                  ...
                  if (null !== i) {
                    for (var c = a(t), h = 0; h < c.length; h++) {
                      ...
                      if ('object' === o(f) && null !== f) {
                        if (!K(i, f, n, r)) return !1;
                      } else if (!n && !e.has(f) && !K(i, f, n, r)) return !1;
                    }
                    return 0 === i.size;
                  }
                  return !0;
                ...
                !(function (e, t, n, i) {
                  for (var s = null, a = l(e), u = 0; u < a.length; u++) {
                    ...
                    if ('object' === o(h) && null !== h)
                      ...
                      var d = t.get(h);
                      if ((void 0 === d && !t.has(h)) || !q(f, d, n, i)) {
                        if (n) return !1;
                        if (!$(e, t, h, f, i)) return !1;
                        null === s && (s = new Set()), s.add(h);
                      }
                    }
                  }
                  if (null !== s) {
                    for (var g = l(t), m = 0; m < g.length; m++) {
                      ...
                      if ('object' === o(b) && null !== b) {
                        if (!z(s, e, b, y, n, i)) return !1;
                      } else if (
                        !(
                          n ||
                          (e.has(b) && q(e.get(b), y, !1, i)) ||
                          z(s, e, b, y, !1, i)
                        )
                      )
                        return !1;
              ...
              for (; c < e.length; c++) {
                if (!d(e, c)) {
                  ...
                  for (var h = Object.keys(e); c < h.length; c++) {
                    var f = h[c];
                    if (!d(t, f) || !q(e[f], t[f], n, s)) return !1;
                  }
                  return h.length === Object.keys(t).length;
                }
                if (!d(t, c) || !q(e[c], t[c], n, s)) return !1;
              }
            for (c = 0; c < i.length; c++) {
              var g = i[c];
              if (!q(e[g], t[g], n, s)) return !1;
            }
            return !0;
          })(e, t, n, u, i, s);
        ...
        function K(e, t, n, r) {
          for (var i = a(e), o = 0; o < i.length; o++) {
            var s = i[o];
            if (q(t, s, n, r)) return e.delete(s), !0;
          }
          return !1;
        }
        function U(e) {
        ...
        function z(e, t, n, r, i, o) {
          for (var s = a(e), l = 0; l < s.length; l++) {
            var u = s[l];
            if (q(n, u, i, o) && q(r, t.get(u), i, o)) return e.delete(u), !0;
          }
          return !1;
        }
        e.exports = {
      ...
      528: (e, t, n) => {
        ...
        var y = function e(t) {
          ...
          C = _.call(Function.call, String.prototype.replace),
          L = _.call(Function.call, String.prototype.slice),
          ...
          R = function (e, t) {
            var n,
              r = e;
            if ((w(v, r) && (r = '%' + (n = v[r])[0] + '%'), w(p, r))) {
              var o = p[r];
              if ((o === g && (o = y(r)), void 0 === o && !t))
                throw new s(
                  'intrinsic ' +
                    e +
        ...
        e.exports = function (e, t) {
          ...
          var n = (function (e) {
              ...
              var r = [];
              return (
                C(e, A, function (e, t, n, i) {
                  r[r.length] = n ? C(i, x, '$1') : t || e;
                }),
                r
              );
            })(e),
        ...
        if (!Object.keys) {
          ...
          r = function (e) {
            ...
            if (r && e.length > 0)
              ...
              for (var b in e)
                (g && 'prototype' === b) || !i.call(e, b) || f.push(String(b));
            if (l)
              for (
                var y = (function (e) {
      ...
      531: (e, t, n) => {
        ...
        (t.isArgumentsObject = r),
          ...
          (t.isSet = function (e) {
            return (
              'undefined' != typeof Set && (y.working ? y(e) : e instanceof Set)
            );
          }),
        ...
        function A(e) {
          return (
            void 0 !== L &&
            (void 0 === N.working && (N.working = N(new L())),
            N.working ? N(e) : e instanceof L)
          );
        }
        function x(e) {
          return p(e, h);
      ...
      208: (e, t, n) => {
        ...
        function d(e, n, r) {
          ...
          return (
            S(n) && (c = ' ' + RegExp.prototype.toString.call(n)),
            C(n) && (c = ' ' + Date.prototype.toUTCString.call(n)),
            L(n) && (c = ' ' + g(n)),
  ...
  (n.g = (function () {
    ...
    (() => {
      ...
      class w {
        constructor(e) {
          (this.element = e),
            (this.next = w.Undefined),
            (this.prev = w.Undefined);
        }
      }
      w.Undefined = new w(void 0);
      class S {
        constructor() {
          (this._first = w.Undefined),
            (this._last = w.Undefined),
            (this._size = 0);
        }
        get size() {
          return this._size;
        ...
        clear() {
          ...
          for (; e !== w.Undefined; ) {
            const t = e.next;
            (e.prev = w.Undefined), (e.next = w.Undefined), (e = t);
          }
          (this._first = w.Undefined),
            (this._last = w.Undefined),
            (this._size = 0);
        ...
        _insert(e, t) {
          const n = new w(e);
          if (this._first === w.Undefined) (this._first = n), (this._last = n);
          else if (t) {
            const e = this._last;
        ...
        _remove(e) {
          if (e.prev !== w.Undefined && e.next !== w.Undefined) {
            const t = e.prev;
            (t.next = e.next), (e.next.prev = t);
          } else
            e.prev === w.Undefined && e.next === w.Undefined
              ? ((this._first = w.Undefined), (this._last = w.Undefined))
              : e.next === w.Undefined
              ? ((this._last = this._last.prev),
                (this._last.next = w.Undefined))
              : e.prev === w.Undefined &&
                ((this._first = this._first.next),
                (this._first.prev = w.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let e = this._first;
          for (; e !== w.Undefined; ) yield e.element, (e = e.next);
        }
      }
      const E =
      ...
      !(function (e) {
        ...
        class u {
          constructor(e, n) {
            ...
            n || t(), (this.emitter = new k(r)), n && n.add(this.emitter);
          }
          beginUpdate(e) {
            this._counter++;
          }
      ...
      class k {
            ...
            (null !== (e = this._event) && void 0 !== e) ||
              (this._event = (e, t, n) => {
                ...
                this._leakageMon &&
                  ...
                  this._listeners
                    ? this._listeners instanceof O
                      ? ((null !== (a = this._deliveryQueue) && void 0 !== a) ||
                          (this._deliveryQueue = new M()),
        ...
        _removeListener(e) {
          ...
          if (-1 === s)
            throw (
              (L.log('disposed?', this._disposed),
              L.log('size?', this._size),
              L.log('arr?', JSON.stringify(this._listeners)),
        ...
        fire(e) {
          ...
          if (
            ...
            if (this._listeners instanceof O) this._deliver(this._listeners, e);
            else {
      ...
      const ie =
          'string' ==
          typeof (null === (D = null == re ? void 0 : re.versions) ||
          void 0 === D
            ? void 0
            : D.electron),
      ...
      if ('object' == typeof re) {
        (U = 'win32' === re.platform),
          (W = 'darwin' === re.platform),
          ($ = 'linux' === re.platform),
          (z = $ && !!re.env.SNAP && !!re.env.SNAP_REVISION),
          (J = ie),
        ...
        q.error('Unable to resolve platform.');
      else {
        (K = navigator.userAgent),
          (U = K.indexOf('Windows') >= 0),
          (W = K.indexOf('Macintosh') >= 0),
          (Y =
            (K.indexOf('Macintosh') >= 0 ||
              K.indexOf('iPad') >= 0 ||
              K.indexOf('iPhone') >= 0) &&
            !!navigator.maxTouchPoints &&
            navigator.maxTouchPoints > 0),
          ($ = K.indexOf('Linux') >= 0),
          (X = (null == K ? void 0 : K.indexOf('Mobi')) >= 0),
          (G = !0);
        (V = void F(0, '_') || B), (Z = V), (ee = navigator.language);
      }
      let se = 0;
      W ? (se = 1) : U ? (se = 3) : $ && (se = 2);
      const ae = U,
        le = W,
        ue = (G && 'function' == typeof ne.importScripts && ne.origin, K),
      ...
      (de = Se),
        (Se.ambiguousCharacterData = new fe(() =>
          JSON.parse(
      ...
      class Ee {
        ...
        static getData() {
          return (
            this._data || (this._data = new Set(Ee.getRawData())), this._data
          );
        }
        static isInvisibleCharacter(e) {
          return Ee.getData().has(e);
        }
      ...
      class ke {
        ...
        sendMessage(e, t) {
          ...
          return new Promise((r, i) => {
            (this._pendingReplies[n] = { resolve: r, reject: i }),
              this._send(new Ne(this._workerId, n, e, t));
          });
        }
        listen(e, t) {
          let n = null;
          const r = new k({
            ...
            onDidRemoveLastListener: () => {
              this._pendingEmitters.delete(n),
                this._send(new Oe(this._workerId, n)),
                (n = null);
            },
          });
          return r.event;
        ...
        _handleReplyMessage(e) {
          if (!this._pendingReplies[e.seq])
            return void Ce.warn('Got reply to unknown seq');
          ...
          this._handler.handleMessage(e.method, e.args).then(
            ...
            e => {
              e.detail instanceof Error && (e.detail = r(e.detail)),
                this._send(new Ae(this._workerId, t, void 0, r(e)));
            },
          );
        }
        _handleSubscribeEventMessage(e) {
          const t = e.req,
            n = this._handler.handleEvent(
              ...
              this._send(new Re(this._workerId, t, e));
            });
        ...
        _handleEventMessage(e) {
          this._pendingEmitters.has(e.req)
            ...
            : Ce.warn('Got event for unknown req');
        }
        _handleUnsubscribeEventMessage(e) {
          this._pendingEvents.has(e.req)
            ...
            : Ce.warn('Got unsubscribe for unknown req');
        }
        _send(e) {
          const t = [];
          if (0 === e.type)
      ...
      function Te(e, t, n) {
        const r = e =>
          ...
          o = {};
        for (const t of e)
          Pe(t) ? (o[t] = i(t)) : Me(t) ? (o[t] = n(t, void 0)) : (o[t] = r(t));
        return o;
      }
      class Ie {
        constructor(e, t) {
        ...
        _handleMessage(e, t) {
          if (e === Le) return this.initialize(t[0], t[1], t[2], t[3]);
          if (
      ...
      function je(e, t) {
        t = De(149417, t);
        for (let n = 0, r = e.length; n < r; n++) t = De(e.charCodeAt(n), t);
        return t;
      }
      function qe(e, t, n = 32) {
        const r = n - t;
        return ((e << t) | ((~((1 << r) - 1) & e) >>> r)) >>> 0;
      }
      function Be(e, t = 0, n = e.byteLength, r = 0) {
      ...
      class Ke {
        ...
        _wrapUp() {
          (this._buff[this._buffLen++] = 128),
            Be(this._buff, this._buffLen),
            this._buffLen > 56 && (this._step(), Be(this._buff));
        ...
        _step() {
          ...
          for (let t = 0; t < 80; t++)
            t < 20
              ...
              (i =
                (qe(o, 5) + n + u + r + e.getUint32(4 * t, !1)) & 4294967295),
              (u = l),
              (l = a),
              (a = qe(s, 30)),
              (s = o),
      ...
      function We(e, t, n) {
        return new Ge(new Ue(e), new Ue(t)).ComputeDiff(n).changes;
      }
      class $e {
        static Assert(e, t) {
      ...
      class Ge {
        ...
        static _getElements(e) {
          ...
          if (Ge._isStringArray(t)) {
            ...
            for (let n = 0, r = t.length; n < r; n++) e[n] = je(t[n], 0);
            return [t, e, !0];
          }
        ...
        ComputeDiffRecursive(e, t, n, r, i) {
          ...
          if (!i[0]) {
            ...
            return (
              (s = i[0]
                ? [new Fe(l + 1, t - (l + 1) + 1, u + 1, r - (u + 1) + 1)]
                : this.ComputeDiffRecursive(l + 1, t, u + 1, r, i)),
              this.ConcatenateChanges(o, s)
            );
          }
          return [new Fe(e, t - e + 1, n, r - n + 1)];
        }
        WALKTRACE(e, t, n, r, i, o, s, a, l, u, c, h, f, d, g, m, p, b) {
          let y = null,
            v = null,
            _ = new He(),
            w = t,
        ...
        ComputeRecursionPoint(e, t, n, r, i, o, s) {
          ...
          for (let S = 1; S <= d / 2 + 1; S++) {
            let d = 0,
              E = 0;
            (u = this.ClipDiagonalBound(b - S, S, b, g)),
              (c = this.ClipDiagonalBound(b + S, S, b, g));
            for (let e = u; e <= c; e += 2) {
              (a =
                e === u || (e < c && m[e - 1] < m[e + 1])
                  ? m[e + 1]
            ...
            if (
              ...
              !this.ContinueProcessingPredicate(d, C)
            )
              return (
                (s[0] = !0),
                (i[0] = d),
                ...
                C > 0 && S <= 1448
                  ...
                  : (e++, n++, [new Fe(e, t - e + 1, n, r - n + 1)])
              );
            (h = this.ClipDiagonalBound(y - S, S, y, g)),
              (f = this.ClipDiagonalBound(y + S, S, y, g));
            for (let d = h; d <= f; d += 2) {
              (a =
                d === h || (d < f && p[d - 1] >= p[d + 1])
                  ? p[d + 1] - 1
              ...
              if (((p[d] = a), w && Math.abs(d - b) <= S && a <= m[d]))
                return (
                  (i[0] = a),
                  (o[0] = l),
                  g >= m[d] && S <= 1448
      ...
      class St {
        ...
        static parse(e, t = !1) {
          ...
          return n
            ...
            : new Ct(vt, vt, vt, vt, vt);
        }
        static file(e) {
          let t = vt;
          if ((ae && (e = e.replace(/\\/g, _t)), e[0] === _t && e[1] === _t)) {
            const n = e.indexOf(_t, 2);
            -1 === n
              ? ((t = e.substring(2)), (e = _t))
              : ((t = e.substring(2, n)), (e = e.substring(n) || _t));
          }
          return new Ct('file', t, e, vt, vt);
        }
        static from(e, t) {
          return new Ct(e.scheme, e.authority, e.path, e.query, e.fragment, t);
        }
        static joinPath(e, ...t) {
          if (!e.path)
            throw new Error(
          ...
          if (e) {
            if (e instanceof St) return e;
            {
              ...
              return (
                ...
                (r._fsPath =
                  e._sep === Et && null !== (n = e.fsPath) && void 0 !== n
                    ? n
                    : null),
                r
              );
      ...
      class Ct extends St {
        ...
        toJSON() {
          const e = { $mid: 1 };
          return (
            this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Et)),
      ...
      function At(e) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e.charCodeAt(n);
          35 === r || 63 === r
            ? (void 0 === t && (t = e.substr(0, n)), (t += Lt[r]))
            : void 0 !== t && (t += e[n]);
        }
        return void 0 !== t ? t : e;
      }
      ...
      const kt = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
      function Mt(e) {
        return e.match(kt) ? e.replace(kt, e => Ot(e)) : e;
      }
      class Pt {
        constructor(e, t) {
        ...
        isBeforeOrEqual(e) {
          return Pt.isBeforeOrEqual(this, e);
        }
        ...
        static lift(e) {
          return new Pt(e.lineNumber, e.column);
        }
      ...
      class Tt {
        ...
        containsPosition(e) {
          return Tt.containsPosition(this, e);
        }
        ...
        containsRange(e) {
          return Tt.containsRange(this, e);
        }
        ...
        strictContainsRange(e) {
          return Tt.strictContainsRange(this, e);
        }
        ...
        intersectRanges(e) {
          return Tt.intersectRanges(this, e);
        }
        static intersectRanges(e, t) {
          ...
          return (
            ...
            n > i || (n === i && r > o) ? null : new Tt(n, r, i, o)
          );
        }
        equalsRange(e) {
          return Tt.equalsRange(this, e);
        }
        ...
        getEndPosition() {
          return Tt.getEndPosition(this);
        }
        static getEndPosition(e) {
          return new Pt(e.endLineNumber, e.endColumn);
        }
        getStartPosition() {
          return Tt.getStartPosition(this);
        }
        static getStartPosition(e) {
          return new Pt(e.startLineNumber, e.startColumn);
        }
        toString() {
          return (
            '[' +
        ...
        setEndPosition(e, t) {
          return new Tt(this.startLineNumber, this.startColumn, e, t);
        }
        setStartPosition(e, t) {
          return new Tt(e, t, this.endLineNumber, this.endColumn);
        }
        collapseToStart() {
          return Tt.collapseToStart(this);
        }
        ...
        static fromPositions(e, t = e) {
          return new Tt(e.lineNumber, e.column, t.lineNumber, t.column);
        }
        static lift(e) {
          return e
            ? new Tt(
      ...
      class jt {
        ...
        filter(e) {
          return new jt(t => this.iterate(n => !e(n) || t(n)));
        }
        map(e) {
          return new jt(t => this.iterate(n => t(e(n))));
        }
        findLast(e) {
          let t;
          ...
          for (const e of t)
            this._acceptDeleteRange(e.range),
              this._acceptInsertText(
                new Pt(e.range.startLineNumber, e.range.startColumn),
                e.text,
              );
      ...
      function Ht(e, t, n, r, i) {
        if (((t = $t(t)), i || (i = c.first(zt)), n.length > i.maxLen)) {
          let o = e - i.maxLen / 2;
          return (
            o < 0 ? (o = 0) : (r += o),
      ...
      !(function (e) {
        (e.isCancellationToken = function (t) {
          ...
          (e.None = Object.freeze({
            ...
            onCancellationRequested: N.None,
          })),
      ...
      class on {
        ...
        get onCancellationRequested() {
          return this._isCancelled
            ? nn
            : (this._emitter || (this._emitter = new k()), this._emitter.event);
        }
        dispose() {
      ...
      class vn extends Tt {
        ...
        getPosition() {
          return new Pt(this.positionLineNumber, this.positionColumn);
        }
        getSelectionStart() {
          return new Pt(
            this.selectionStartLineNumber,
      ...
      const En = {
        add: Sn('add', 6e4),
        plus: Sn('plus', 6e4),
        gistNew: Sn('gist-new', 6e4),
        repoCreate: Sn('repo-create', 6e4),
        lightbulb: Sn('lightbulb', 60001),
        lightBulb: Sn('light-bulb', 60001),
        repo: Sn('repo', 60002),
        repoDelete: Sn('repo-delete', 60002),
        gistFork: Sn('gist-fork', 60003),
        repoForked: Sn('repo-forked', 60003),
        gitPullRequest: Sn('git-pull-request', 60004),
        gitPullRequestAbandoned: Sn('git-pull-request-abandoned', 60004),
        recordKeys: Sn('record-keys', 60005),
        keyboard: Sn('keyboard', 60005),
        tag: Sn('tag', 60006),
        tagAdd: Sn('tag-add', 60006),
        tagRemove: Sn('tag-remove', 60006),
        gitPullRequestLabel: Sn('git-pull-request-label', 60006),
        person: Sn('person', 60007),
        personFollow: Sn('person-follow', 60007),
        personOutline: Sn('person-outline', 60007),
        personFilled: Sn('person-filled', 60007),
        gitBranch: Sn('git-branch', 60008),
        gitBranchCreate: Sn('git-branch-create', 60008),
        gitBranchDelete: Sn('git-branch-delete', 60008),
        sourceControl: Sn('source-control', 60008),
        mirror: Sn('mirror', 60009),
        mirrorPublic: Sn('mirror-public', 60009),
        star: Sn('star', 60010),
        starAdd: Sn('star-add', 60010),
        starDelete: Sn('star-delete', 60010),
        starEmpty: Sn('star-empty', 60010),
        comment: Sn('comment', 60011),
        commentAdd: Sn('comment-add', 60011),
        alert: Sn('alert', 60012),
        warning: Sn('warning', 60012),
        search: Sn('search', 60013),
        searchSave: Sn('search-save', 60013),
        logOut: Sn('log-out', 60014),
        signOut: Sn('sign-out', 60014),
        logIn: Sn('log-in', 60015),
        signIn: Sn('sign-in', 60015),
        eye: Sn('eye', 60016),
        eyeUnwatch: Sn('eye-unwatch', 60016),
        eyeWatch: Sn('eye-watch', 60016),
        circleFilled: Sn('circle-filled', 60017),
        primitiveDot: Sn('primitive-dot', 60017),
        closeDirty: Sn('close-dirty', 60017),
        debugBreakpoint: Sn('debug-breakpoint', 60017),
        debugBreakpointDisabled: Sn('debug-breakpoint-disabled', 60017),
        debugBreakpointPending: Sn('debug-breakpoint-pending', 60377),
        debugHint: Sn('debug-hint', 60017),
        primitiveSquare: Sn('primitive-square', 60018),
        edit: Sn('edit', 60019),
        pencil: Sn('pencil', 60019),
        info: Sn('info', 60020),
        issueOpened: Sn('issue-opened', 60020),
        gistPrivate: Sn('gist-private', 60021),
        gitForkPrivate: Sn('git-fork-private', 60021),
        lock: Sn('lock', 60021),
        mirrorPrivate: Sn('mirror-private', 60021),
        close: Sn('close', 60022),
        removeClose: Sn('remove-close', 60022),
        x: Sn('x', 60022),
        repoSync: Sn('repo-sync', 60023),
        sync: Sn('sync', 60023),
        clone: Sn('clone', 60024),
        desktopDownload: Sn('desktop-download', 60024),
        beaker: Sn('beaker', 60025),
        microscope: Sn('microscope', 60025),
        vm: Sn('vm', 60026),
        deviceDesktop: Sn('device-desktop', 60026),
        file: Sn('file', 60027),
        fileText: Sn('file-text', 60027),
        more: Sn('more', 60028),
        ellipsis: Sn('ellipsis', 60028),
        kebabHorizontal: Sn('kebab-horizontal', 60028),
        mailReply: Sn('mail-reply', 60029),
        reply: Sn('reply', 60029),
        organization: Sn('organization', 60030),
        organizationFilled: Sn('organization-filled', 60030),
        organizationOutline: Sn('organization-outline', 60030),
        newFile: Sn('new-file', 60031),
        fileAdd: Sn('file-add', 60031),
        newFolder: Sn('new-folder', 60032),
        fileDirectoryCreate: Sn('file-directory-create', 60032),
        trash: Sn('trash', 60033),
        trashcan: Sn('trashcan', 60033),
        history: Sn('history', 60034),
        clock: Sn('clock', 60034),
        folder: Sn('folder', 60035),
        fileDirectory: Sn('file-directory', 60035),
        symbolFolder: Sn('symbol-folder', 60035),
        logoGithub: Sn('logo-github', 60036),
        markGithub: Sn('mark-github', 60036),
        github: Sn('github', 60036),
        terminal: Sn('terminal', 60037),
        console: Sn('console', 60037),
        repl: Sn('repl', 60037),
        zap: Sn('zap', 60038),
        symbolEvent: Sn('symbol-event', 60038),
        error: Sn('error', 60039),
        stop: Sn('stop', 60039),
        variable: Sn('variable', 60040),
        symbolVariable: Sn('symbol-variable', 60040),
        array: Sn('array', 60042),
        symbolArray: Sn('symbol-array', 60042),
        symbolModule: Sn('symbol-module', 60043),
        symbolPackage: Sn('symbol-package', 60043),
        symbolNamespace: Sn('symbol-namespace', 60043),
        symbolObject: Sn('symbol-object', 60043),
        symbolMethod: Sn('symbol-method', 60044),
        symbolFunction: Sn('symbol-function', 60044),
        symbolConstructor: Sn('symbol-constructor', 60044),
        symbolBoolean: Sn('symbol-boolean', 60047),
        symbolNull: Sn('symbol-null', 60047),
        symbolNumeric: Sn('symbol-numeric', 60048),
        symbolNumber: Sn('symbol-number', 60048),
        symbolStructure: Sn('symbol-structure', 60049),
        symbolStruct: Sn('symbol-struct', 60049),
        symbolParameter: Sn('symbol-parameter', 60050),
        symbolTypeParameter: Sn('symbol-type-parameter', 60050),
        symbolKey: Sn('symbol-key', 60051),
        symbolText: Sn('symbol-text', 60051),
        symbolReference: Sn('symbol-reference', 60052),
        goToFile: Sn('go-to-file', 60052),
        symbolEnum: Sn('symbol-enum', 60053),
        symbolValue: Sn('symbol-value', 60053),
        symbolRuler: Sn('symbol-ruler', 60054),
        symbolUnit: Sn('symbol-unit', 60054),
        activateBreakpoints: Sn('activate-breakpoints', 60055),
        archive: Sn('archive', 60056),
        arrowBoth: Sn('arrow-both', 60057),
        arrowDown: Sn('arrow-down', 60058),
        arrowLeft: Sn('arrow-left', 60059),
        arrowRight: Sn('arrow-right', 60060),
        arrowSmallDown: Sn('arrow-small-down', 60061),
        arrowSmallLeft: Sn('arrow-small-left', 60062),
        arrowSmallRight: Sn('arrow-small-right', 60063),
        arrowSmallUp: Sn('arrow-small-up', 60064),
        arrowUp: Sn('arrow-up', 60065),
        bell: Sn('bell', 60066),
        bold: Sn('bold', 60067),
        book: Sn('book', 60068),
        bookmark: Sn('bookmark', 60069),
        debugBreakpointConditionalUnverified: Sn(
          'debug-breakpoint-conditional-unverified',
          60070,
        ),
        debugBreakpointConditional: Sn('debug-breakpoint-conditional', 60071),
        debugBreakpointConditionalDisabled: Sn(
          'debug-breakpoint-conditional-disabled',
          60071,
        ),
        debugBreakpointDataUnverified: Sn(
          'debug-breakpoint-data-unverified',
          60072,
        ),
        debugBreakpointData: Sn('debug-breakpoint-data', 60073),
        debugBreakpointDataDisabled: Sn(
          'debug-breakpoint-data-disabled',
          60073,
        ),
        debugBreakpointLogUnverified: Sn(
          'debug-breakpoint-log-unverified',
          60074,
        ),
        debugBreakpointLog: Sn('debug-breakpoint-log', 60075),
        debugBreakpointLogDisabled: Sn('debug-breakpoint-log-disabled', 60075),
        briefcase: Sn('briefcase', 60076),
        broadcast: Sn('broadcast', 60077),
        browser: Sn('browser', 60078),
        bug: Sn('bug', 60079),
        calendar: Sn('calendar', 60080),
        caseSensitive: Sn('case-sensitive', 60081),
        check: Sn('check', 60082),
        checklist: Sn('checklist', 60083),
        chevronDown: Sn('chevron-down', 60084),
        dropDownButton: Sn('drop-down-button', 60084),
        chevronLeft: Sn('chevron-left', 60085),
        chevronRight: Sn('chevron-right', 60086),
        chevronUp: Sn('chevron-up', 60087),
        chromeClose: Sn('chrome-close', 60088),
        chromeMaximize: Sn('chrome-maximize', 60089),
        chromeMinimize: Sn('chrome-minimize', 60090),
        chromeRestore: Sn('chrome-restore', 60091),
        circle: Sn('circle', 60092),
        circleOutline: Sn('circle-outline', 60092),
        debugBreakpointUnverified: Sn('debug-breakpoint-unverified', 60092),
        circleSlash: Sn('circle-slash', 60093),
        circuitBoard: Sn('circuit-board', 60094),
        clearAll: Sn('clear-all', 60095),
        clippy: Sn('clippy', 60096),
        closeAll: Sn('close-all', 60097),
        cloudDownload: Sn('cloud-download', 60098),
        cloudUpload: Sn('cloud-upload', 60099),
        code: Sn('code', 60100),
        collapseAll: Sn('collapse-all', 60101),
        colorMode: Sn('color-mode', 60102),
        commentDiscussion: Sn('comment-discussion', 60103),
        compareChanges: Sn('compare-changes', 60157),
        creditCard: Sn('credit-card', 60105),
        dash: Sn('dash', 60108),
        dashboard: Sn('dashboard', 60109),
        database: Sn('database', 60110),
        debugContinue: Sn('debug-continue', 60111),
        debugDisconnect: Sn('debug-disconnect', 60112),
        debugPause: Sn('debug-pause', 60113),
        debugRestart: Sn('debug-restart', 60114),
        debugStart: Sn('debug-start', 60115),
        debugStepInto: Sn('debug-step-into', 60116),
        debugStepOut: Sn('debug-step-out', 60117),
        debugStepOver: Sn('debug-step-over', 60118),
        debugStop: Sn('debug-stop', 60119),
        debug: Sn('debug', 60120),
        deviceCameraVideo: Sn('device-camera-video', 60121),
        deviceCamera: Sn('device-camera', 60122),
        deviceMobile: Sn('device-mobile', 60123),
        diffAdded: Sn('diff-added', 60124),
        diffIgnored: Sn('diff-ignored', 60125),
        diffModified: Sn('diff-modified', 60126),
        diffRemoved: Sn('diff-removed', 60127),
        diffRenamed: Sn('diff-renamed', 60128),
        diff: Sn('diff', 60129),
        discard: Sn('discard', 60130),
        editorLayout: Sn('editor-layout', 60131),
        emptyWindow: Sn('empty-window', 60132),
        exclude: Sn('exclude', 60133),
        extensions: Sn('extensions', 60134),
        eyeClosed: Sn('eye-closed', 60135),
        fileBinary: Sn('file-binary', 60136),
        fileCode: Sn('file-code', 60137),
        fileMedia: Sn('file-media', 60138),
        filePdf: Sn('file-pdf', 60139),
        fileSubmodule: Sn('file-submodule', 60140),
        fileSymlinkDirectory: Sn('file-symlink-directory', 60141),
        fileSymlinkFile: Sn('file-symlink-file', 60142),
        fileZip: Sn('file-zip', 60143),
        files: Sn('files', 60144),
        filter: Sn('filter', 60145),
        flame: Sn('flame', 60146),
        foldDown: Sn('fold-down', 60147),
        foldUp: Sn('fold-up', 60148),
        fold: Sn('fold', 60149),
        folderActive: Sn('folder-active', 60150),
        folderOpened: Sn('folder-opened', 60151),
        gear: Sn('gear', 60152),
        gift: Sn('gift', 60153),
        gistSecret: Sn('gist-secret', 60154),
        gist: Sn('gist', 60155),
        gitCommit: Sn('git-commit', 60156),
        gitCompare: Sn('git-compare', 60157),
        gitMerge: Sn('git-merge', 60158),
        githubAction: Sn('github-action', 60159),
        githubAlt: Sn('github-alt', 60160),
        globe: Sn('globe', 60161),
        grabber: Sn('grabber', 60162),
        graph: Sn('graph', 60163),
        gripper: Sn('gripper', 60164),
        heart: Sn('heart', 60165),
        home: Sn('home', 60166),
        horizontalRule: Sn('horizontal-rule', 60167),
        hubot: Sn('hubot', 60168),
        inbox: Sn('inbox', 60169),
        issueClosed: Sn('issue-closed', 60324),
        issueReopened: Sn('issue-reopened', 60171),
        issues: Sn('issues', 60172),
        italic: Sn('italic', 60173),
        jersey: Sn('jersey', 60174),
        json: Sn('json', 60175),
        bracket: Sn('bracket', 60175),
        kebabVertical: Sn('kebab-vertical', 60176),
        key: Sn('key', 60177),
        law: Sn('law', 60178),
        lightbulbAutofix: Sn('lightbulb-autofix', 60179),
        linkExternal: Sn('link-external', 60180),
        link: Sn('link', 60181),
        listOrdered: Sn('list-ordered', 60182),
        listUnordered: Sn('list-unordered', 60183),
        liveShare: Sn('live-share', 60184),
        loading: Sn('loading', 60185),
        location: Sn('location', 60186),
        mailRead: Sn('mail-read', 60187),
        mail: Sn('mail', 60188),
        markdown: Sn('markdown', 60189),
        megaphone: Sn('megaphone', 60190),
        mention: Sn('mention', 60191),
        milestone: Sn('milestone', 60192),
        gitPullRequestMilestone: Sn('git-pull-request-milestone', 60192),
        mortarBoard: Sn('mortar-board', 60193),
        move: Sn('move', 60194),
        multipleWindows: Sn('multiple-windows', 60195),
        mute: Sn('mute', 60196),
        noNewline: Sn('no-newline', 60197),
        note: Sn('note', 60198),
        octoface: Sn('octoface', 60199),
        openPreview: Sn('open-preview', 60200),
        package: Sn('package', 60201),
        paintcan: Sn('paintcan', 60202),
        pin: Sn('pin', 60203),
        play: Sn('play', 60204),
        run: Sn('run', 60204),
        plug: Sn('plug', 60205),
        preserveCase: Sn('preserve-case', 60206),
        preview: Sn('preview', 60207),
        project: Sn('project', 60208),
        pulse: Sn('pulse', 60209),
        question: Sn('question', 60210),
        quote: Sn('quote', 60211),
        radioTower: Sn('radio-tower', 60212),
        reactions: Sn('reactions', 60213),
        references: Sn('references', 60214),
        refresh: Sn('refresh', 60215),
        regex: Sn('regex', 60216),
        remoteExplorer: Sn('remote-explorer', 60217),
        remote: Sn('remote', 60218),
        remove: Sn('remove', 60219),
        replaceAll: Sn('replace-all', 60220),
        replace: Sn('replace', 60221),
        repoClone: Sn('repo-clone', 60222),
        repoForcePush: Sn('repo-force-push', 60223),
        repoPull: Sn('repo-pull', 60224),
        repoPush: Sn('repo-push', 60225),
        report: Sn('report', 60226),
        requestChanges: Sn('request-changes', 60227),
        rocket: Sn('rocket', 60228),
        rootFolderOpened: Sn('root-folder-opened', 60229),
        rootFolder: Sn('root-folder', 60230),
        rss: Sn('rss', 60231),
        ruby: Sn('ruby', 60232),
        saveAll: Sn('save-all', 60233),
        saveAs: Sn('save-as', 60234),
        save: Sn('save', 60235),
        screenFull: Sn('screen-full', 60236),
        screenNormal: Sn('screen-normal', 60237),
        searchStop: Sn('search-stop', 60238),
        server: Sn('server', 60240),
        settingsGear: Sn('settings-gear', 60241),
        settings: Sn('settings', 60242),
        shield: Sn('shield', 60243),
        smiley: Sn('smiley', 60244),
        sortPrecedence: Sn('sort-precedence', 60245),
        splitHorizontal: Sn('split-horizontal', 60246),
        splitVertical: Sn('split-vertical', 60247),
        squirrel: Sn('squirrel', 60248),
        starFull: Sn('star-full', 60249),
        starHalf: Sn('star-half', 60250),
        symbolClass: Sn('symbol-class', 60251),
        symbolColor: Sn('symbol-color', 60252),
        symbolCustomColor: Sn('symbol-customcolor', 60252),
        symbolConstant: Sn('symbol-constant', 60253),
        symbolEnumMember: Sn('symbol-enum-member', 60254),
        symbolField: Sn('symbol-field', 60255),
        symbolFile: Sn('symbol-file', 60256),
        symbolInterface: Sn('symbol-interface', 60257),
        symbolKeyword: Sn('symbol-keyword', 60258),
        symbolMisc: Sn('symbol-misc', 60259),
        symbolOperator: Sn('symbol-operator', 60260),
        symbolProperty: Sn('symbol-property', 60261),
        wrench: Sn('wrench', 60261),
        wrenchSubaction: Sn('wrench-subaction', 60261),
        symbolSnippet: Sn('symbol-snippet', 60262),
        tasklist: Sn('tasklist', 60263),
        telescope: Sn('telescope', 60264),
        textSize: Sn('text-size', 60265),
        threeBars: Sn('three-bars', 60266),
        thumbsdown: Sn('thumbsdown', 60267),
        thumbsup: Sn('thumbsup', 60268),
        tools: Sn('tools', 60269),
        triangleDown: Sn('triangle-down', 60270),
        triangleLeft: Sn('triangle-left', 60271),
        triangleRight: Sn('triangle-right', 60272),
        triangleUp: Sn('triangle-up', 60273),
        twitter: Sn('twitter', 60274),
        unfold: Sn('unfold', 60275),
        unlock: Sn('unlock', 60276),
        unmute: Sn('unmute', 60277),
        unverified: Sn('unverified', 60278),
        verified: Sn('verified', 60279),
        versions: Sn('versions', 60280),
        vmActive: Sn('vm-active', 60281),
        vmOutline: Sn('vm-outline', 60282),
        vmRunning: Sn('vm-running', 60283),
        watch: Sn('watch', 60284),
        whitespace: Sn('whitespace', 60285),
        wholeWord: Sn('whole-word', 60286),
        window: Sn('window', 60287),
        wordWrap: Sn('word-wrap', 60288),
        zoomIn: Sn('zoom-in', 60289),
        zoomOut: Sn('zoom-out', 60290),
        listFilter: Sn('list-filter', 60291),
        listFlat: Sn('list-flat', 60292),
        listSelection: Sn('list-selection', 60293),
        selection: Sn('selection', 60293),
        listTree: Sn('list-tree', 60294),
        debugBreakpointFunctionUnverified: Sn(
          'debug-breakpoint-function-unverified',
          60295,
        ),
        debugBreakpointFunction: Sn('debug-breakpoint-function', 60296),
        debugBreakpointFunctionDisabled: Sn(
          'debug-breakpoint-function-disabled',
          60296,
        ),
        debugStackframeActive: Sn('debug-stackframe-active', 60297),
        circleSmallFilled: Sn('circle-small-filled', 60298),
        debugStackframeDot: Sn('debug-stackframe-dot', 60298),
        debugStackframe: Sn('debug-stackframe', 60299),
        debugStackframeFocused: Sn('debug-stackframe-focused', 60299),
        debugBreakpointUnsupported: Sn('debug-breakpoint-unsupported', 60300),
        symbolString: Sn('symbol-string', 60301),
        debugReverseContinue: Sn('debug-reverse-continue', 60302),
        debugStepBack: Sn('debug-step-back', 60303),
        debugRestartFrame: Sn('debug-restart-frame', 60304),
        callIncoming: Sn('call-incoming', 60306),
        callOutgoing: Sn('call-outgoing', 60307),
        menu: Sn('menu', 60308),
        expandAll: Sn('expand-all', 60309),
        feedback: Sn('feedback', 60310),
        gitPullRequestReviewer: Sn('git-pull-request-reviewer', 60310),
        groupByRefType: Sn('group-by-ref-type', 60311),
        ungroupByRefType: Sn('ungroup-by-ref-type', 60312),
        account: Sn('account', 60313),
        gitPullRequestAssignee: Sn('git-pull-request-assignee', 60313),
        bellDot: Sn('bell-dot', 60314),
        debugConsole: Sn('debug-console', 60315),
        library: Sn('library', 60316),
        output: Sn('output', 60317),
        runAll: Sn('run-all', 60318),
        syncIgnored: Sn('sync-ignored', 60319),
        pinned: Sn('pinned', 60320),
        githubInverted: Sn('github-inverted', 60321),
        debugAlt: Sn('debug-alt', 60305),
        serverProcess: Sn('server-process', 60322),
        serverEnvironment: Sn('server-environment', 60323),
        pass: Sn('pass', 60324),
        stopCircle: Sn('stop-circle', 60325),
        playCircle: Sn('play-circle', 60326),
        record: Sn('record', 60327),
        debugAltSmall: Sn('debug-alt-small', 60328),
        vmConnect: Sn('vm-connect', 60329),
        cloud: Sn('cloud', 60330),
        merge: Sn('merge', 60331),
        exportIcon: Sn('export', 60332),
        graphLeft: Sn('graph-left', 60333),
        magnet: Sn('magnet', 60334),
        notebook: Sn('notebook', 60335),
        redo: Sn('redo', 60336),
        checkAll: Sn('check-all', 60337),
        pinnedDirty: Sn('pinned-dirty', 60338),
        passFilled: Sn('pass-filled', 60339),
        circleLargeFilled: Sn('circle-large-filled', 60340),
        circleLarge: Sn('circle-large', 60341),
        circleLargeOutline: Sn('circle-large-outline', 60341),
        combine: Sn('combine', 60342),
        gather: Sn('gather', 60342),
        table: Sn('table', 60343),
        variableGroup: Sn('variable-group', 60344),
        typeHierarchy: Sn('type-hierarchy', 60345),
        typeHierarchySub: Sn('type-hierarchy-sub', 60346),
        typeHierarchySuper: Sn('type-hierarchy-super', 60347),
        gitPullRequestCreate: Sn('git-pull-request-create', 60348),
        runAbove: Sn('run-above', 60349),
        runBelow: Sn('run-below', 60350),
        notebookTemplate: Sn('notebook-template', 60351),
        debugRerun: Sn('debug-rerun', 60352),
        workspaceTrusted: Sn('workspace-trusted', 60353),
        workspaceUntrusted: Sn('workspace-untrusted', 60354),
        workspaceUnspecified: Sn('workspace-unspecified', 60355),
        terminalCmd: Sn('terminal-cmd', 60356),
        terminalDebian: Sn('terminal-debian', 60357),
        terminalLinux: Sn('terminal-linux', 60358),
        terminalPowershell: Sn('terminal-powershell', 60359),
        terminalTmux: Sn('terminal-tmux', 60360),
        terminalUbuntu: Sn('terminal-ubuntu', 60361),
        terminalBash: Sn('terminal-bash', 60362),
        arrowSwap: Sn('arrow-swap', 60363),
        copy: Sn('copy', 60364),
        personAdd: Sn('person-add', 60365),
        filterFilled: Sn('filter-filled', 60366),
        wand: Sn('wand', 60367),
        debugLineByLine: Sn('debug-line-by-line', 60368),
        inspect: Sn('inspect', 60369),
        layers: Sn('layers', 60370),
        layersDot: Sn('layers-dot', 60371),
        layersActive: Sn('layers-active', 60372),
        compass: Sn('compass', 60373),
        compassDot: Sn('compass-dot', 60374),
        compassActive: Sn('compass-active', 60375),
        azure: Sn('azure', 60376),
        issueDraft: Sn('issue-draft', 60377),
        gitPullRequestClosed: Sn('git-pull-request-closed', 60378),
        gitPullRequestDraft: Sn('git-pull-request-draft', 60379),
        debugAll: Sn('debug-all', 60380),
        debugCoverage: Sn('debug-coverage', 60381),
        runErrors: Sn('run-errors', 60382),
        folderLibrary: Sn('folder-library', 60383),
        debugContinueSmall: Sn('debug-continue-small', 60384),
        beakerStop: Sn('beaker-stop', 60385),
        graphLine: Sn('graph-line', 60386),
        graphScatter: Sn('graph-scatter', 60387),
        pieChart: Sn('pie-chart', 60388),
        bracketDot: Sn('bracket-dot', 60389),
        bracketError: Sn('bracket-error', 60390),
        lockSmall: Sn('lock-small', 60391),
        azureDevops: Sn('azure-devops', 60392),
        verifiedFilled: Sn('verified-filled', 60393),
        newLine: Sn('newline', 60394),
        layout: Sn('layout', 60395),
        layoutActivitybarLeft: Sn('layout-activitybar-left', 60396),
        layoutActivitybarRight: Sn('layout-activitybar-right', 60397),
        layoutPanelLeft: Sn('layout-panel-left', 60398),
        layoutPanelCenter: Sn('layout-panel-center', 60399),
        layoutPanelJustify: Sn('layout-panel-justify', 60400),
        layoutPanelRight: Sn('layout-panel-right', 60401),
        layoutPanel: Sn('layout-panel', 60402),
        layoutSidebarLeft: Sn('layout-sidebar-left', 60403),
        layoutSidebarRight: Sn('layout-sidebar-right', 60404),
        layoutStatusbar: Sn('layout-statusbar', 60405),
        layoutMenubar: Sn('layout-menubar', 60406),
        layoutCentered: Sn('layout-centered', 60407),
        layoutSidebarRightOff: Sn('layout-sidebar-right-off', 60416),
        layoutPanelOff: Sn('layout-panel-off', 60417),
        layoutSidebarLeftOff: Sn('layout-sidebar-left-off', 60418),
        target: Sn('target', 60408),
        indent: Sn('indent', 60409),
        recordSmall: Sn('record-small', 60410),
        errorSmall: Sn('error-small', 60411),
        arrowCircleDown: Sn('arrow-circle-down', 60412),
        arrowCircleLeft: Sn('arrow-circle-left', 60413),
        arrowCircleRight: Sn('arrow-circle-right', 60414),
        arrowCircleUp: Sn('arrow-circle-up', 60415),
        heartFilled: Sn('heart-filled', 60420),
        map: Sn('map', 60421),
        mapFilled: Sn('map-filled', 60422),
        circleSmall: Sn('circle-small', 60423),
        bellSlash: Sn('bell-slash', 60424),
        bellSlashDot: Sn('bell-slash-dot', 60425),
        commentUnresolved: Sn('comment-unresolved', 60426),
        gitPullRequestGoToChanges: Sn('git-pull-request-go-to-changes', 60427),
        gitPullRequestNewChanges: Sn('git-pull-request-new-changes', 60428),
        searchFuzzy: Sn('search-fuzzy', 60429),
        commentDraft: Sn('comment-draft', 60430),
        send: Sn('send', 60431),
        sparkle: Sn('sparkle', 60432),
        insert: Sn('insert', 60433),
        mic: Sn('mic', 60434),
        thumbsDownFilled: Sn('thumbsdown-filled', 60435),
        thumbsUpFilled: Sn('thumbsup-filled', 60436),
        coffee: Sn('coffee', 60437),
        snake: Sn('snake', 60438),
        game: Sn('game', 60439),
        vr: Sn('vr', 60440),
        chip: Sn('chip', 60441),
        piano: Sn('piano', 60442),
        music: Sn('music', 60443),
        micFilled: Sn('mic-filled', 60444),
        gitFetch: Sn('git-fetch', 60445),
        copilot: Sn('copilot', 60446),
        lightbulbSparkle: Sn('lightbulb-sparkle', 60447),
        lightbulbSparkleAutofix: Sn('lightbulb-sparkle-autofix', 60447),
        robot: Sn('robot', 60448),
        sparkleFilled: Sn('sparkle-filled', 60449),
        diffSingle: Sn('diff-single', 60450),
        diffMultiple: Sn('diff-multiple', 60451),
        surroundWith: Sn('surround-with', 60452),
        gitStash: Sn('git-stash', 60454),
        gitStashApply: Sn('git-stash-apply', 60455),
        gitStashPop: Sn('git-stash-pop', 60456),
        runAllCoverage: Sn('run-all-coverage', 60461),
        runCoverage: Sn('run-all-coverage', 60460),
        coverage: Sn('coverage', 60462),
        githubProject: Sn('github-project', 60463),
        dialogError: Sn('dialog-error', 'error'),
        dialogWarning: Sn('dialog-warning', 'warning'),
        dialogInfo: Sn('dialog-info', 'info'),
        dialogClose: Sn('dialog-close', 'close'),
        treeItemExpanded: Sn('tree-item-expanded', 'chevron-down'),
        treeFilterOnTypeOn: Sn('tree-filter-on-type-on', 'list-filter'),
        treeFilterOnTypeOff: Sn('tree-filter-on-type-off', 'list-selection'),
        treeFilterClear: Sn('tree-filter-clear', 'close'),
        treeItemLoading: Sn('tree-item-loading', 'loading'),
        menuSelection: Sn('menu-selection', 'check'),
        menuSubmenu: Sn('menu-submenu', 'chevron-right'),
        menuBarMore: Sn('menubar-more', 'more'),
        scrollbarButtonLeft: Sn('scrollbar-button-left', 'triangle-left'),
        scrollbarButtonRight: Sn('scrollbar-button-right', 'triangle-right'),
        scrollbarButtonUp: Sn('scrollbar-button-up', 'triangle-up'),
        scrollbarButtonDown: Sn('scrollbar-button-down', 'triangle-down'),
        toolBarMore: Sn('toolbar-more', 'more'),
        quickInputBack: Sn('quick-input-back', 'arrow-left'),
      };
      class Cn extends _ {
        get isResolved() {
      ...
      !(function (e) {
        const t = new Map();
        t.set(0, En.symbolMethod),
          t.set(1, En.symbolFunction),
          t.set(2, En.symbolConstructor),
          t.set(3, En.symbolField),
          t.set(4, En.symbolVariable),
          t.set(5, En.symbolClass),
          t.set(6, En.symbolStruct),
          t.set(7, En.symbolInterface),
          t.set(8, En.symbolModule),
          t.set(9, En.symbolProperty),
          t.set(10, En.symbolEvent),
          t.set(11, En.symbolOperator),
          t.set(12, En.symbolUnit),
          t.set(13, En.symbolValue),
          t.set(15, En.symbolEnum),
          t.set(14, En.symbolConstant),
          t.set(15, En.symbolEnum),
          t.set(16, En.symbolEnumMember),
          t.set(17, En.symbolKeyword),
          t.set(27, En.symbolSnippet),
          t.set(18, En.symbolText),
          t.set(19, En.symbolColor),
          t.set(20, En.symbolFile),
          t.set(21, En.symbolReference),
          t.set(22, En.symbolCustomColor),
          t.set(23, En.symbolFolder),
          t.set(24, En.symbolTypeParameter),
          t.set(25, En.account),
          t.set(26, En.issues),
          (e.toIcon = function (e) {
            let n = t.get(e);
            return (
              n ||
                (Rn.info('No codicon found for CompletionItemKind ' + e),
                (n = En.symbolProperty)),
              n
            );
          });
      ...
      !(function (e) {
        const t = new Map();
        t.set(0, En.symbolFile),
          t.set(1, En.symbolModule),
          t.set(2, En.symbolNamespace),
          t.set(3, En.symbolPackage),
          t.set(4, En.symbolClass),
          t.set(5, En.symbolMethod),
          t.set(6, En.symbolProperty),
          t.set(7, En.symbolField),
          t.set(8, En.symbolConstructor),
          t.set(9, En.symbolEnum),
          t.set(10, En.symbolInterface),
          t.set(11, En.symbolFunction),
          t.set(12, En.symbolVariable),
          t.set(13, En.symbolConstant),
          t.set(14, En.symbolString),
          t.set(15, En.symbolNumber),
          t.set(16, En.symbolBoolean),
          t.set(17, En.symbolArray),
          t.set(18, En.symbolObject),
          t.set(19, En.symbolKey),
          t.set(20, En.symbolNull),
          t.set(21, En.symbolEnumMember),
          t.set(22, En.symbolStruct),
          t.set(23, En.symbolEvent),
          t.set(24, En.symbolOperator),
          t.set(25, En.symbolTypeParameter),
          (e.toIcon = function (e) {
            let n = t.get(e);
            return (
              n ||
                (Rn.info('No codicon found for SymbolKind ' + e),
                (n = En.symbolProperty)),
              n
            );
          });
        ...
        next(e) {
          ...
          do {
            ...
            if (
              ...
              !this._wordSeparators || kr(this._wordSeparators, e, t, r, i))
            )
              return n;
          } while (n);
          return null;
          ...
          e: for (let t = r, n = i; t <= n; t++) {
            ...
            do {
              if (((c = l.next(n)), c)) {
                ...
                if (0 !== l) {
                  3 === l ? f++ : 2 === l ? d++ : 1 === l ? g++ : Pr();
                  const n = 1e3;
                  if (u.length >= n) {
                    h = !0;
                    break e;
                  }
                  u.push(new Tt(t, e + 1, t, i + 1));
                }
              }
            } while (c);
          }
      ...
      class Dr {
        constructor(e) {
          (this.options = e),
            ...
            (this.ambiguousCharacters = Se.getInstance(
        ...
        getCandidateCodePoints() {
          ...
          if (this.options.invisibleCharacters)
            for (const t of Ee.codePoints)
              jr(String.fromCodePoint(t)) || e.add(t);
      ...
      class Vr {
        ...
        delta(e) {
          return new Vr(this.start + e, this.endExclusive + e);
        }
        deltaStart(e) {
          return new Vr(this.start + e, this.endExclusive);
        }
        deltaEnd(e) {
          return new Vr(this.start, this.endExclusive + e);
        }
        get length() {
      ...
      function Wr(e, t, n = 0, r = e.length) {
        let i = n,
          o = r;
        for (; i < o; ) {
          const n = Math.floor((i + o) / 2);
      ...
      class $r {
        ...
        findLastMonotonous(e) {
          ...
          const t = Ur(this._array, e, this._findLastMonotonousLastIdx);
          return (
      ...
      class Hr {
        ...
        contains(e) {
          const t = Kr(this._normalizedRanges, t => t.startLineNumber <= e);
      ...
      class Yr {
        ...
        flip() {
          return new Yr(this.modifiedRange, this.originalRange);
        }
      }
      class Qr {
        computeDiff(e, t, n) {
      ...
      class ai {
        static trivial(e, t) {
          return new ai(
            [new li(Vr.ofLength(e.length), Vr.ofLength(t.length))],
            !1,
          );
        }
      ...
      class li {
        ...
        static fromOffsetPairs(e, t) {
          return new li(
            new Vr(e.offset1, t.offset1),
            new Vr(e.offset2, t.offset2),
          );
        }
        constructor(e, t) {
      ...
      class mi {
        compute(e, t, n = ci.instance, r) {
          ...
          function c(e, t) {
            (e + 1 === l && t + 1 === u) ||
              a.push(new li(new Vr(e + 1, l), new Vr(t + 1, u))),
              (l = e),
              (u = t);
          }
          let h = e.length - 1,
      ...
      class pi {
        compute(e, t, n = ci.instance) {
          ...
          a.set(0, o(0, 0));
          const l = new vi();
          l.set(0, 0 === a.get(0) ? null : new bi(null, 0, 0, a.get(0)));
          let u = 0;
          e: for (;;) {
            ...
            for (u = e; u <= t; u += 2) {
              ...
              if (
                (l.set(u, d !== h ? new bi(g, h, f, d - h) : g),
          ...
          for (;;) {
            ...
            if (
              ((e === f && t === d) ||
                h.push(new li(new Vr(e, f), new Vr(t, d))),
              !c)
            )
              break;
      ...
      class Si {
        constructor(e, t) {
          if (((this[_i] = 'ResourceMap'), e instanceof Si))
            (this.map = new Map(e.map)),
              (this.toKey = null != t ? t : Si.defaultToKey);
          else if (
            (function (e) {
              return Array.isArray(e);
            })(e)
            ...
            (this.map = new Map()),
              (this.toKey = null != e ? e : Si.defaultToKey);
        }
        set(e, t) {
          return this.map.set(this.toKey(e), new wi(e, t)), this;
        }
        get(e) {
          var t;
        ...
        *[((_i = Symbol.toStringTag), Symbol.iterator)]() {
          for (const [, e] of this.map) yield [e.uri, e.value];
        }
      }
      Si.defaultToKey = e => e.toString();
      ...
      class Ci {
        constructor(e, t, n) {
          ...
          t.start > 0 &&
            ...
            ((t = new Vr(t.start - 1, t.endExclusive)), (r = !0)),
            (this.lineRange = t),
        ...
        get text() {
          return this.getText(new Vr(0, this.length));
        }
        getText(e) {
        ...
        getBoundaryScore(e) {
          const t = xi(e > 0 ? this.elements[e - 1] : -1),
            n = xi(e < this.elements.length ? this.elements[e] : -1);
          if (7 === t && 8 === n) return 0;
          if (8 === t) return 150;
          let r = 0;
          return (
        ...
        translateOffset(e) {
          if (this.lineRange.isEmpty)
            return new Pt(this.lineRange.start + 1, 1);
          const t = Ur(this.firstCharOffsetByLine, t => t <= e);
          return new Pt(
        ...
        extendToFullLines(e) {
          ...
          const r =
              null !==
                (t = Kr(this.firstCharOffsetByLine, t => t <= e.start)) &&
              void 0 !== t
                ? t
                : 0,
            i =
      ...
      const Ni = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
      function Ai(e) {
        return Ni[e];
      }
      function xi(e) {
      ...
      function Ri(e, t, n, r, i, o) {
        ...
        const l = (function (e, t, n, r, i, o) {
          ...
          const l = [];
          e.sort(Ft(e => e.modified.startLineNumber, Dt));
          for (const t of e) {
            let e = [];
            for (
          ...
          l.sort(
            ((u = Ft(e => e.modifiedLineRange.length, Dt)), (e, t) => -u(e, t)),
          );
          var u;
          const c = new Hr(),
            h = new Hr();
          ...
          s.sort(Ft(e => e.original.startLineNumber, Dt));
          const f = new $r(e);
          for (let t = 0; t < s.length; t++) {
            ...
            for (
              ...
              const e = n.original.endLineNumberExclusive + b,
                t = n.modified.endLineNumberExclusive + b;
              if (e > r.length || t > i.length) break;
              if (c.contains(t) || h.contains(e)) break;
              if (!Oi(r[e - 1], i[t - 1], o)) break;
            }
            b > 0 &&
              (h.addRange(
                new zr(
                  n.original.endLineNumberExclusive,
                  n.original.endLineNumberExclusive + b,
                ),
              ),
              c.addRange(
                new zr(
                  n.modified.endLineNumberExclusive,
                  n.modified.endLineNumberExclusive + b,
                ),
              )),
              (p > 0 || b > 0) &&
                (s[t] = new Gr(
        ...
        return (
          ...
          (s = (function (e) {
            ...
            e.sort(Ft(e => e.original.startLineNumber, Dt));
            const t = [e[0]];
            for (let n = 1; n < e.length; n++) {
      ...
      function Oi(e, t, n) {
        ...
        const r = new pi().compute(
          new Ci([e], new Vr(0, 1), !1),
          new Ci([t], new Vr(0, 1), !1),
          n,
        );
        let i = 0;
      ...
      function Mi(e, t, n) {
        ...
        for (let i = 1; i < n.length; i++) {
          ...
          if (s.seq1Range.isEmpty || s.seq2Range.isEmpty) {
            ...
            if ((i--, i === n)) {
              r[r.length - 1] = new li(
                new Vr(o.seq1Range.start, s.seq1Range.endExclusive - n),
                new Vr(o.seq2Range.start, s.seq2Range.endExclusive - n),
              );
              continue;
            }
            s = s.delta(-i);
        ...
        for (let n = 0; n < r.length - 1; n++) {
          ...
          if (s.seq1Range.isEmpty || s.seq2Range.isEmpty) {
            ...
            if (a === i) {
              r[n + 1] = new li(
                new Vr(s.seq1Range.start + i, o.seq1Range.endExclusive),
                new Vr(s.seq2Range.start + i, o.seq2Range.endExclusive),
              );
              continue;
            }
            a > 0 && (s = s.delta(a));
      ...
      class Fi {
        ...
        computeDiff(e, t, n) {
            ...
            return new qr(
              [
                new Jr(new zr(1, e.length + 1), new zr(1, t.length + 1), [
                  new Yr(
                    new Tt(1, 1, e.length, e[0].length + 1),
                    new Tt(1, 1, t.length, t[0].length + 1),
                  ),
                ]),
              ],
              [],
                ...
                for (let o = 0; o < n; o++) {
                  ...
                  if (e[n] !== t[s]) {
                    const o = this.refineDiff(
                      e,
                      t,
                      new li(new Vr(n, n + 1), new Vr(s, s + 1)),
                      r,
                      i,
                    );
          ...
          let p = 0,
            b = 0;
          for (const n of f) {
            Tr(() => n.seq1Range.start - p == n.seq2Range.start - b);
            m(n.seq1Range.start - p),
              (p = n.seq1Range.endExclusive),
              (b = n.seq2Range.endExclusive);
          ...
          let v = [];
          return (
            n.computeMoves && (v = this.computeMoves(y, e, t, a, l, r, i)),
            Tr(() => {
              function n(e, t) {
        ...
        refineDiff(e, t, n, r, i) {
          const o = new Ci(e, n.seq1Range, i),
            s = new Ci(t, n.seq2Range, i),
            a =
              ...
              return (
                (function (e, t) {
                  ...
                  const a = e.extendToFullLines(n.seq1Range),
                    l = e.getText(new Vr(a.start, n.seq1Range.start));
                  o(l) && (i = i.deltaStart(-l.length));
                  const u = e.getText(
                    new Vr(n.seq1Range.endExclusive, a.endExclusive),
                  );
      ...
      class Vi {
        constructor(e, t, n, r = 1) {
          (this._rgbaBrand = void 0),
            ...
            (this.a = Bi(Math.max(Math.min(1, r), 0), 3));
        }
        static equals(e, t) {
      ...
      class Ki {
        constructor(e, t, n, r) {
          (this._hslaBrand = void 0),
            ...
            (this.s = Bi(Math.max(Math.min(1, t), 0), 3)),
            (this.l = Bi(Math.max(Math.min(1, n), 0), 3)),
            (this.a = Bi(Math.max(Math.min(1, r), 0), 3));
        }
        static equals(e, t) {
      ...
      class Ui {
        constructor(e, t, n, r) {
          (this._hsvaBrand = void 0),
            (this.h = 0 | Math.max(Math.min(360, e), 0)),
            (this.s = Bi(Math.max(Math.min(1, t), 0), 3)),
            (this.v = Bi(Math.max(Math.min(1, n), 0), 3)),
            (this.a = Bi(Math.max(Math.min(1, r), 0), 3));
        }
        static equals(e, t) {
          ...
          return (
            (a =
              0 === o
                ...
                ? (r - t) / o + 2
                : (t - n) / o + 4),
            new Ui(Math.round(60 * a), s, i, e.a)
          );
        }
        static toRGBA(e) {
      ...
      class Wi {
        static fromHex(e) {
          return Wi.Format.CSS.parseHex(e) || Wi.red;
        }
        static equals(e, t) {
        ...
        constructor(e) {
          ...
          if (e instanceof Vi) this.rgba = e;
        ...
        equals(e) {
          return (
            !!e &&
            Vi.equals(this.rgba, e.rgba) &&
            Ki.equals(this.hsla, e.hsla) &&
            Ui.equals(this.hsva, e.hsva)
          );
        }
        getRelativeLuminance() {
          return Bi(
            0.2126 * Wi._relativeLuminanceForComponent(this.rgba.r) +
              0.7152 * Wi._relativeLuminanceForComponent(this.rgba.g) +
              0.0722 * Wi._relativeLuminanceForComponent(this.rgba.b),
            4,
          );
        }
        ...
        transparent(e) {
          ...
          return new Wi(new Vi(t, n, r, i * e));
        }
        isTransparent() {
        ...
        toString() {
          return (
            this._toString || (this._toString = Wi.Format.CSS.format(this)),
            this._toString
          );
        }
      ...
      function Ji(e, t, n) {
        ...
        const r = $i(t[0].values());
        return { range: e, color: zi(r[0], r[1], r[2], n ? r[3] : 1) };
      }
      function Yi(e, t, n) {
        if (!e || 1 !== t.length) return;
        const r = $i(t[0].values()),
          i = new Wi(new Ki(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
      ...
      (Wi.white = new Wi(new Vi(255, 255, 255, 1))),
        (Wi.black = new Wi(new Vi(0, 0, 0, 1))),
        (Wi.red = new Wi(new Vi(255, 0, 0, 1))),
        (Wi.blue = new Wi(new Vi(0, 0, 255, 1))),
        (Wi.green = new Wi(new Vi(0, 255, 0, 1))),
        (Wi.cyan = new Wi(new Vi(0, 255, 255, 1))),
        (Wi.lightgrey = new Wi(new Vi(211, 211, 211, 1))),
        (Wi.transparent = new Wi(new Vi(0, 0, 0, 0))),
        (function (e) {
          let t;
          !(function (t) {
            let n;
              ...
              (t.formatRGB = function (t) {
                ...
                (t.parseHex = function (t) {
                  ...
                  if (9 === n) {
                    ...
                    return new e(new Vi(n, i, o, s / 255));
                  }
                  if (4 === n) {
                    const n = r(t.charCodeAt(1)),
                      i = r(t.charCodeAt(2)),
                      o = r(t.charCodeAt(3));
                    return new e(new Vi(16 * n + n, 16 * i + i, 16 * o + o));
                  }
                  if (5 === n) {
                    const n = r(t.charCodeAt(1)),
                      i = r(t.charCodeAt(2)),
      ...
      class Zi extends Ut {
        ...
        getWordAtPosition(e, t) {
          const n = Ht(e.column, $t(t), this._lines[e.lineNumber - 1], 0);
          return n
            ? new Tt(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
            : null;
        }
        words(e) {
          const t = this._lines,
        ...
        _validatePosition(e) {
          if (!Pt.isIPosition(e)) throw new Error('bad position');
      ...
      class eo {
        ...
        async computeUnicodeHighlights(e, t, n) {
          ...
          return r
            ? Fr.computeUnicodeHighlights(r, t, n)
            : {
                ranges: [],
                hasMore: !1,
        ...
        async computeMoreMinimalEdits(e, t, n) {
          ...
          t = t.slice(0).sort((e, t) => {
            if (e.range && t.range)
              return Tt.compareRangesUsingStarts(e.range, t.range);
            return (e.range ? 0 : 1) - (t.range ? 0 : 1);
          });
          let s = 0;
          for (let e = 1; e < t.length; e++)
            Tt.getEndPosition(t[s].range).equals(
              Tt.getStartPosition(t[e].range),
            )
              ? ((t[s].range = Tt.fromPositions(
                  Tt.getStartPosition(t[s].range),
                  Tt.getEndPosition(t[e].range),
                )),
                (t[s].text += t[e].text))
              : (s++, (t[s] = t[e]));
          t.length = s + 1;
          for (let { range: e, text: s, eol: a } of t) {
            if (('number' == typeof a && (o = a), Tt.isEmpty(e) && !s))
              continue;
            ...
            const l = We(t, s, n),
              u = r.offsetAt(Tt.lift(e).getStartPosition());
            for (const e of l) {
